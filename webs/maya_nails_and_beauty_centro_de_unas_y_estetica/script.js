...
const hasVideo = "peluqueria.mp4" !== "NONE";

if (container) {
    renderer.setSize(window.innerWidth, window.innerHeight);
    renderer.setClearColor(0x0d0d0d, hasVideo ? 0 : 1); // Transparente si hay video
...
if (resForm) {
    resForm.addEventListener('submit', (e) => {
        ...
        const whatsappUrl = `https://wa.me/34643711590?text=${encodedText}`;
