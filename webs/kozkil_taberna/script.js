...
const hasVideo = "video_banner.mp4" !== "NONE";

if (container) {
    renderer.setSize(window.innerWidth, window.innerHeight);
    renderer.setClearColor(0x050505, hasVideo ? 0 : 1); // Transparente si hay video
...
if (resForm) {
    resForm.addEventListener('submit', (e) => {
        ...
        const whatsappUrl = `https://wa.me/34635947078?text=${encodedText}`;
...
window.addEventListener('load', () => {
    ...
    const videoUrl = "video_banner.mp4";
