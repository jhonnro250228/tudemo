...
const hasVideo = "panaderia.mp4" !== "NONE";

if (container) {
    renderer.setSize(window.innerWidth, window.innerHeight);
    renderer.setClearColor(0x051a05, hasVideo ? 0 : 1); // Transparente si hay video
...
if (resForm) {
    resForm.addEventListener('submit', (e) => {
        ...
        const whatsappUrl = `https://wa.me/34652728471?text=${encodedText}`;
